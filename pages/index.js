      ...
      <div className="p-5 bg-gray-50">
        ...
        <h1 className='flex justify-between text-3xl text-black font-semibold mb-6 '>
          ...
          <a href="https://github.com/Pritesh55/next-v1"
            className=' hover:bg-blue-600 hover:text-white px-4 py-2 text-lg bg-transparent text-blue-700 border-2 rounded-lg border-blue-700'>
            Github Link
          </a>
        </h1>
        ...
        <div className="headless-ui-tab">
          ...
          <Tab.Group>
            ...
            <Tab.Panels>
              ...
              <Tab.Panel className="bg-white px-1 py-0 min-h-screen border-2 border-gray-400 relative z-10 -mt-0.5">
